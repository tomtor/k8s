...
pg_dumpall -r -h localhost -U postgresadmin -p $PORT > roles.sql
...
#pg_dump -Fc -Z 1 -h localhost -U postgresadmin -p $PORT -n bagactueel tom | pv | azbak --no-suffix - "/public/bag.$DATE.backup"
