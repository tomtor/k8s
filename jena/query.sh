...
echo 'CREATE INDEX IF NOT EXISTS pand10wkbidx ON public.pand10 USING gist (wkb_geometry) TABLESPACE pg_default;' | psql -A -t bgt
...
#echo 'select count(*) from pand10 as a, pand10 as b where a.gml_id != b.gml_id and a.area > 1000 and st_distance(a.wkb_geometry,b.wkb_geometry) < 10' | psql -A -t bgt
